...
public class BinairNaarNegatieveGetallen {
	...
	public static void main(String[] args) {
		...
		if (binairNaarDecimaalGetal == willekeurigNegatiefGetal) {
			System.out.println(ANSI_GREEN + "Correct" + ANSI_RESET);
		} else {
			System.out.println(ANSI_RED + String.format("Fout, de oplossing moest %d zijn", willekeurigNegatiefGetal) + ANSI_RESET);
		}
